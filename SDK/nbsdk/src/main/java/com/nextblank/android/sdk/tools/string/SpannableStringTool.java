package com.nextblank.android.sdk.tools.string;
...
public final class SpannableStringTool {


    private static final Object lock = new Object();
    private static volatile SpannableStringTool instance;

    private SpannableStringTool() {
    }

    public static SpannableStringTool instance() {
        if (instance == null) {
            synchronized (lock) {
                if (instance == null) {
                    instance = new SpannableStringTool();
                }
            }
        }
        return instance;
    ...
    public class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new CustomImageSpan(Tools.app(), bitmap, align), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new CustomImageSpan(Tools.app(), uri, align), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new CustomImageSpan(Tools.app(), resourceId, align), start, end, flag);
                    resourceId = 0;
