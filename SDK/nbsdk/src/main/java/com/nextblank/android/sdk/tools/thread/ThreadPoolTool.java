package com.nextblank.android.sdk.tools.thread;
...
public final class ThreadPoolTool {
    ...
    private static volatile ThreadPoolTool instance;

    private ThreadPoolTool() {
    }

    public static ThreadPoolTool instance() {
        if (instance == null) {
            synchronized (lock) {
                if (instance == null) {
                    instance = new ThreadPoolTool();
                }
            }
        }
        return instance;
     ...
     */
    public ThreadPoolTool(@Type int type, int corePoolSize) {
        // 构造有定时功能的线程池
